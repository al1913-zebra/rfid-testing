...
How do I know if RFID is right for my application? (Q1)
## 03


Is there a chance RFID won’t work for me? (Q2)
## 04
...
How much will an RFID system cost? (Q3)


Can I try RFID before investing in a full system? (Q4)
What do I need for a full system? (Q5)


How do I choose my RFID hardware? (Q6)


How do I choose RFID tags? (Q7)


Can I get RFID tags pre-printed and pre-encoded? (Q8)
What sort of software will I need for my RFID system? (Q9)
Can I setup an RFID system without software? (Q10)


Do I need a software engineer on staff? (Q11)
Who installs the RFID system? (Q12)


Is there a recommended way to set up RFID hardware and get started? (Q13)


How many read zones are needed and where will they be located? (Q14)
There are items in my facility that contain liquids/metals; does that mean RFID
will not work for me? (Q15)


What if I want to use RFID in my facility for more than one application? Should
I have separate RFID systems? (Q16)
How long does a typical RFID system take to deploy? (Q17)


How do I train my employees on RFID? (Q18)


When will I see a return on investment from my RFID system? (Q19)
...
[atlasRFIDstore.com | 2](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### Q: How do I know if RFID is right for my application? A: There are several steps required to answer this question:
...
problem may be as simple as “I can’t find my items when I
...
[consulting with an RFID expert to conduct a site survey, each](http://www.atlasrfidstore.com/RFID-site-survey-consultation/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Site_Survey)
...
would be required in order to achieve a company’s
goals?
...
Deploying an RFID System:
[atlasRFIDstore.com | 3](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
20 Questions & Answers
...
the expected return on investment (assuming the given system will achieve the predefined goals).
...
pure physics standpoint, it may not be possible to deploy an RFID system that is able to capture RFID tags
reads with enough success to meet a company’s goals.


2. Cost/ROI Feasibility – RFID might work well for the
application, but the ROI isn’t significant enough to
justify implementation of the technology.

#### Q: Is there a chance RFID won't work for me? A: Yes, RFID is not the answer for every application. The
...
tags, or if an RFID system’s costs outweigh the value added, then
RFID shouldn’t be implemented. Ideally, such aspects would
be determined during the business definition and scoping
process.


[atlasRFIDstore.com | 4](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### Q: How much will an RFID system cost? A: Because RFID systems can differ greatly in size from one

handheld reader and a few tags to hundreds of readers and
antennas and thousands of tags, there isn’t a particular cost (or
...
[atlasRFIDstore.com | 5](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### Q: Can I try RFID before investing in a full system? A: Yes, RFID development kits and RFID tag sample packs are
...
#### Q: What do I need for a full RFID system? A: Most RFID systems consist of the same basic elements:


     - [Readers - An RFID reader is the “brain” of the RFID](http://www.atlasrfidstore.com/rfid-readers/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Readers)
system and necessary for any system to function. Readers, also called interrogators, are devices that transmit
and receive radio waves in order to communicate with
RFID tags.


     - [Antennas - RFID Antennas are a necessary element](http://www.atlasrfidstore.com/rfid-antennas/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Antennas)
in any RFID system; however, they are “dumb devices” which use power from the reader to generate an RF
field allowing the reader to transmit and receive signals
from the RFID tags.


[atlasRFIDstore.com | 6](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
20 Questions & Answers
     ...
     - [Tags - An RFID tag, in its most simplistic form, is](http://www.atlasrfidstore.com/rfid-tags/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Tags)
comprised of two parts – an antenna for transmitting
and receiving signals, and an RFID chip (or integrated
circuit) which stores the tag’s ID and other information.


     - [Software - Software is essential to all RFID systems.](http://www.atlasrfidstore.com/rfid-software/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Software)
Software allows the reader to operate and communicate with RFID tags, the data collected from tag reads
to shown, sent, stored, etc. so that users can make informed decisions and take actions, or can trigger other systems to take preprogrammed actions. Ultimately,
software can be as simple or complex as required by the
application.


In addition to the basic elements, some systems may also require ancillary devices, such as stack lights, motion sensors,
and other [GPIO devices. The total amount of hardware and](http://www.atlasrfidstore.com/rfid-gpio-devices/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=GPIO_Devices)
software required will ultimately depend upon the system requirements.

#### Q: How do I choose my RFID hardware? A: A large selection of RFID hardware is available and
...
[• RFID Buyer’s Guide - The RFID Buyer’s Guide is a 24](http://rfid.atlasrfidstore.com/rfid-buying-guide/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Buyers_Guide)
...
about their hardware needs.
     ...
     - [How to Select a UHF RFID Reader - This blog post](http://blog.atlasrfidstore.com/how-to-select-uhf-rfid-reader/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Readers)
provides potential RFID users with 3 important factors
to consider when selecting an RFID reader.


[atlasRFIDstore.com | 7](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
[• 3 Guidelines for Choosing a Passive UHF RFID An-](http://blog.atlasrfidstore.com/choose-right-rfid-antenna/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Antennas)
[tenna - This blog post provides potential RFID users](http://blog.atlasrfidstore.com/choose-right-rfid-antenna/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Antennas)
with 3 important factors to consider when selecting an
RFID antenna.


     - [RFID Antenna Cables: Achieving the Highest Per-](http://blog.atlasrfidstore.com/rfid-antenna-cables-getting-the-highest-performance-possible/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Cables)
[formance Possible - All RFID systems use an antenna](http://blog.atlasrfidstore.com/rfid-antenna-cables-getting-the-highest-performance-possible/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Cables)
cable to connect the reader and the antenna. This blog
post provides potential RFID users with important information on how to choose the best RFID antenna cable for their application.

#### Q: How do I choose RFID tags? A: There are hundreds of passive RFID tags on the market, so

choosing the right tag (or set of tags) for any given application
can seem like a daunting task. Similar to choosing RFID
[hardware, selecting the right RFID tag can be accomplished by](http://blog.atlasrfidstore.com/best-rfid-tag-application/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Choosing_RFID_Tags)
...
[• RFID Buyer’s Guide - The RFID Buyer’s Guide is a 24](http://rfid.atlasrfidstore.com/basics-of-an-rfid-system-ebook/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Basics)
question eBook designed to walk potential RFID users
through the buying process. Answering each question
helps to enable the buyers to make informed decisions
about their hardware needs.
...
[• 3 Things to Know About UHF RFID Tags - This blog](http://blog.atlasrfidstore.com/basics-of-uhf-passive-rfid-tags/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=3_Important_Tag_Facts)
post provides potential RFID users with 3 important
things to know about UHF RFID tags to aid in the selection process.


[atlasRFIDstore.com | 8](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### Q: Can I get RFID tags pre-printed and pre-encoded? A: Yes, most RFID tags can be pre-printed and pre-encoded,
...
[encoding RFID tags, please read the FAQs.](http://www.atlasrfidstore.com/custom-rfid-printing-encoding/?__hssc=44538747.22.1454530515501&__hstc=44538747.aabe5ab889c00cc73649b3c1b8d0ce21.1437667366180.1454522300118.1454530515501.303&__hsfp=&hsCtaTracking=5a7991db-6daf-4a4c-b46e-cb82c0c9317e|316c1a5e-7923-4c95-92df-5e40df7b7c17/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Custom_Printing_Encoding)

#### Q: What sort of software will I need for my RFID system? A: Few off-the-shelf (OTS) software packages specifically
...
#### Q: Can I setup an RFID system without software? A: In short, no. Even on a small scale, software must be
...
[atlasRFIDstore.com | 9](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
software (such as the [Impinj Speedway Connect Software)](http://www.atlasrfidstore.com/impinj-speedway-connect-software/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Speedway_Connect_Software)
may be all that is needed. Other times, the project may require
custom software development to meet all specifications.

#### Q: Do I need a software engineer on staff? A: Every company looking to implement RFID does not
...
#### Q: Who installs the RFID system? A: If the purchasing company has a technical team with RFID
...
If a company isn’t 100% confident in its ability to provide the
...
[atlasRFIDstore.com | 10](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### A: Because every facility is different, there isn’t a specific way
...
[about the 6 factors that affect read range.](http://blog.atlasrfidstore.com/improve-rfid-read-range/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=6_Factors)
...
the first time.
    ...
    - Keep the RFID reader and antenna(s) as close as possible in order to reduce the length of antenna cabled
needed and, thus, cut down on cable loss.


      - When mounting RFID antennas, test different locations and antenna angles in order to get the best results.
Also, testing different types of antennas may be beneficial.


[atlasRFIDstore.com | 11](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### A: In short, an RFID read zone should be located at every point
...
would only be necessary at the facility’s entrances/exits.
...
[atlasRFIDstore.com | 12](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
[Read more about multipath issues caused by metal and water](http://blog.atlasrfidstore.com/rfid-multipath-em-waves/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Multipath)
within facilities.
...
#### Q: How long does a typical RFID system take to deploy? A: The timeline for an RFID deployment can vary greatly
...
[atlasRFIDstore.com | 13](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
#### Q: How do I train my employees on RFID? A: If a company decides to implement RFID within a facility,

[key employees should be trained on the basics of RFID – what](http://rfid.atlasrfidstore.com/basics-of-an-rfid-system-ebook/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Basics_Guide)
...
[atlasRFIDstore.com | 14](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
...
to helping customers learn more about RFID:
      ...
      - [RFIDjournal.com - RFID Journal is a news website](http://www.rfidjournal.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Journal)
covering companies and applications around the world
deploying RFID.


      - [RFIDinsider Blog - A go-to blog on all things RFID,](http://blog.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Blog)
specializing in news and knowledge for the beginner,
intermediate, and advanced RFID enthusiasts.


      - [RFID Resources - An atlasRFIDstore webpage dedi-](http://www.atlasrfidstore.com/rfid-resources/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Resources)
cated to eBooks, customer profiles, and videos for enhancing RFID knowledge.


      - [RFID Videos - atlasRFIDstore’s YouTube page con-](https://www.youtube.com/user/atlasRFIDstore/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=RFID_Videos)
taining videos about how RFID works, RFID products,
and tutorials.


[atlasRFIDstore.com | 15](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)


# Contact The

#### contact us. Phone: 1.205.383.2244
# RFID Experts


#### If you have any additional ques- tions about if RFID is right for your application, or about deploying an RFID system, don't hesitate to contact us.


#### Phone: 1.205.383.2244 Email: sales@atlasRFIDstore.com



Deploying an RFID System:
[atlasRFIDstore.com | 16](http://www.atlasrfidstore.com/?utm_source=Deploying_RFID&utm_medium=Deploying_RFID_Link&utm_campaign=Content&utm_content=Home)
20 Questions & Answers
