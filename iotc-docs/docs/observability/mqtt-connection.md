...
> 📘 **EXPLANATION** · **Audience:** Solution Builder, API Consumer · **Read time:** ~4 min · **Ties to:** MQTT Connectivity sub-tag of the API Reference
...
**Related:** 📘 [Watch your reader's pulse](/observability/heartbeat) · 📘 [How the MQTT plumbing fits together](/infrastructure/mqtt-endpoints) · 📘 [What happens when the network drops](/fleet/retention-and-retry) · 📕 [`mqttConnEVT`](https://aa5123.github.io/RFID-40-90-handled-reader-api-reference-documentatiion/)
